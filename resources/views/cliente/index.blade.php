                                    ...
                                    @for ($contador = 0; $contador < 4; $contador++)
                                        @if (isset($produtosDestaques[$contador]))
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="#"><img
                                                            src="{{ 'data:image/jpeg;base64,'.$produtosDestaques[$contador]['foto1'] }}"
                                                            alt=""></a>
                                    ...
                                    <ul class="thumbnails">
                                        ...
                                        @if (isset($produtosDestaques[$contador + 1]))
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="#"><img
                                                            src="{{ 'data:image/jpeg;base64'.$produtosDestaques[$contador + 1]['foto1'] }}"
                                                            alt=""></a>
                                        ...
                                        @if (isset($produtosDestaques[$contador + 2]))
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="#"><img
                                                            src="{{ 'data:image/jpeg;base64'.$produtosDestaques[$contador + 2]['foto1'] }}"
                                                            alt=""></a>
                                        ...
                                        @if (isset($produtosDestaques[$contador + 3]))
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="#"><img
                                                            src="{{'data:image/jpeg;base64'.$produtosDestaques[$contador + 3]['foto1'] }}"
                                                            alt=""></a>
