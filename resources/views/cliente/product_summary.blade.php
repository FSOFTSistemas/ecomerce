...
@section('conteudo')
    <div class="span9">
        ...
        <h3> Carrinho<a href="{{route('home')}}" class="btn btn-large pull-right">
            <i class="icon-arrow-left"></i> Continue comprando </a>
        </h3>
        <hr class="soft" />
        ...
        <a href="{{route('carrinho.finalizar',$pedido->id)}}" class="btn btn-large pull-right">Concluir <i class="icon-arrow-right"></i></a>
