<div class="row">
    ...
    <div class="col-6">
        <div class="input-group mb-3">
            ...
            <input type="text" name="estoque" value="{{isset($produto->estoque) ? $produto->estoque:''}}" class="form-control">
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-6">
        <div class="input-group mb-3">
            ...
            <input type="text" name="referencia" value="{{isset($produto->referencia) ? $produto->referencia:''}}" class="form-control">
        </div>
    </div>
    <div class="col-6">
        <div class="input-group mb-3">
            ...
            <input type="text" name="codigo_de_barras" value="{{isset($produto->codigo_de_barras) ? $produto->codigo_de_barras:''}}" class="form-control">
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-6">
        <div class="input-group mb-3">
            ...
            <input type="text" name="preco_venda" value="{{isset($produto->preco_venda) ? $produto->preco_venda:''}}" class="form-control">
        </div>
    </div>
    <div class="col-6">
        <div class="input-group mb-3">
            ...
            <input type="text" name="preco_promocao" value="{{isset($produto->preco_promocao) ? $produto->preco_promocao:''}}" class="form-control" >
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-6">
        <div class="input-group mb-3">
            ...
            <input type="text" name="tamanho" value="{{isset($produto->tamanho) ? $produto->tamanho:''}}" class="form-control">
        </div>
    </div>
</div>
