...
@section('content_header')
    <h1 class="m-0 text-dark">Relatório de Vendas</h1>
    <hr>
@stop
@section('content')
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <form class="" action="{{ route('filter.venda') }}" method="POST" >
                    @csrf
                    <div class="col">
                        <div class="row">
                ...
                <div class="row">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach ($vendas as $vnd)
                                <tr>
                                    <td>{{ $vnd->data }}</td>
                                    <td> {{ $vnd->user_id }} </td>
                                    <td>R$ {{ number_format($vnd->subtotal, 2) }}</td>
                                    <td>R$ {{ number_format($vnd->total, 2) }}</td>
                                </tr>
                            @endforeach
